    ...
    >
      <section onClick={stopPropagation}>
        ...
        <p className={styles.paragraph}>
          The <strong className={styles.strong}>tonic</strong> is the leftmost
          key pressed, and the start of an ascending musical pattern. The
          default tonic is C4. Change tonic to transpose the pressed keys.
        </p>
        <p className={styles.paragraph}>
        ...
        <p className={styles.paragraph}>
          ...
          which is normally played harmonically (at the same time). Click a
          chord button to see it highlighted for the selected tonic.
        </p>
